...
const DhvaniPage = () => {
  ...
  const features = [
    {
      ...
      description: "Accurately identify individuals with high reliability across different cases using AI-powered voice analysis.",
      metric: "99.9%",
      metricLabel: "Identification Accuracy",
      gradient: "from-blue-50 to-indigo-50"
    },
    {
      icon: <Eraser className="w-6 h-6" />,
      title: "Advanced AI Analysis",
      description: "Leverage AI models to efficiently analyze vast numbers of voice samples.",
      metric: "500K+",
      metricLabel: "Voice Samples Processed",
      gradient: "white"
    },
    {
      icon: <ScrollText className="w-6 h-6" />,
      title: "Trusted by Agencies",
      description: "Used by multiple agencies for secure and precise voice identification operations.",
      metric: "50+",
      metricLabel: "Law Enforcement Agencies Supported",
      gradient: "from-blue-50 to-indigo-50"
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "Real-Time Monitoring",
      description: "Provides uninterrupted service with continuous processing and monitoring.",
      metric: "24/7",
      metricLabel: "Continuous Availability",
      gradient: "white"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Voice Tracking",
      description: "Generates unique voice identifiers for accurate tracking and verification of individuals.",
      metric: "1:1M",
      metricLabel: "Unique Precision",
      gradient: "from-blue-50 to-indigo-50"
    },
    {
      icon: <Files className="w-6 h-6" />,
      title: "Instant Insights",
      description: "Immediate insights with options for manual verification",
      metric: "99.8% ",
      metricLabel: "Immediate Feedback",
      gradient: "white"
    },
    {
      icon: <LineChart className="w-6 h-6" />,
      title: "Faster Investigations",
      description: "Handle multiple cases simultaneously for faster investigations",
      metric: "500+ Cases/day",
      metricLabel: "Multiple Case Handling",
      gradient: "white"
    },
    {
      icon: <LayoutDashboard className="w-6 h-6" />,
      title: "Manage & Monitor",
      description: "Manage and monitor progress with intuitive visualizations",
      metric: "24/7 Availability",
      metricLabel: "Progress Monitoring",
      gradient: "white"
    }
  ...
  const stats = [
    { value: "500K+", label: "Voice Samples Processed", icon: <Activity className="w-5 h-5" /> },
    { value: "99.8%", label: "Identification Accuracy", icon: <Target className="w-5 h-5" /> },
    { value: "50+", label: "LEA Departments", icon: <Building2 className="w-5 h-5" /> },
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center mb-12 group cursor-pointer">
            <div className="flex items-center px-6 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full border border-blue-100/50 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-blue-700 tracking-wide">
                Reliable AI for Voice Analysis
              </span>
          ...
          <div className="mb-16 relative">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-gray-700 tracking-wide">
               AI-Powered  
                <span className="text-blue-600 font-medium"> Voice Analysis</span>
              </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-16 max-w-3xl mx-auto font-light opacity-0 animate-fade-in-delayed">
            Advanced platform for analyzing voice samples and delivering real-time insights for law enforcement.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light">
              AI-powered features for accurate voice analysis and identification.
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    desc: "Deep learning models for precise voice identification and analysis",
                    icon: <FileSearch className="w-5 h-5" />
                  },
                  {
                    number: "02",
                    title: "Contextual NLP Analysis", 
                    desc: "Real-time processing for accurate interpretation of audio data",
                    icon: <Brain className="w-5 h-5" />
                  },
                  {
                    number: "03",
                    title: "Instant Insights",
                    desc: "Proprietary algorithms for enhanced clarity, accuracy, and efficiency",
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-3xl p-4 shadow-lg overflow-hidden">
                ...
                <div className="text-center mb-12">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">
                    <span className="text-blue-600">Core </span> AI Modules
                  </h3>
                  <p className="text-sm text-gray-600 font-light">Essential Components Powering Know Voice</p>
                </div>
                ...
                <div className="space-y-6">
                  {[
                    { 
                      ...
                      description: "Converts audio into accurate, structured text",
                    ...
                    { 
                      ...
                      description: "Detects and tracks individual voices",
                    ...
                    { 
                      ...
                      description: "Organizes and categorizes voice data efficiently",
            ...
            {[
              {
                ...
                features: ["Live analysis", "Instant ID", "Threat detection"],
              ...
              {
                title: "AI Analytics",
                features: ["Pattern recognition", "Behavioral profiling", "Predictive insights"],
                icon: <Brain className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              }
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-16 max-w-2xl mx-auto font-light">
            Measurable results that demonstrate the power of AI-driven voice analysis
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { value: "67%", label: "Crime Reduction", desc: "Faster case resolution", icon: <TrendingUp className="w-5 h-5" /> },
              { value: "10x", label: "Investigation Speed", desc: "Accelerated analysis", icon: <Zap className="w-5 h-5" /> },
              { value: "94%", label: "Success Rate", desc: "Higher conviction rates", icon: <Award className="w-5 h-5" /> }
            ].map((impact, index) => (
              <div
                key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed font-light max-w-2xl mx-auto">
              Experience the future of voice-based cybercrime investigation with cutting-edge AI technology.
            </p>
          </div>
