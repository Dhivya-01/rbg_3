...
const DhvaniPage = () => {
  ...
  const features = [
    {
      ...
      description: "Leverage cutting-edge Optical Character Recognition (OCR) technology to accurately extract text from scanned or image-based documents and Captchas.",
      metric: "99.9%",
    ...
    },
    {
      ...
      title: "Minimizes Manual Errors",
      description: "Employs advanced algorithms to reduce manual errors and ensure precise outputs.",
      metric: "95%",
      metricLabel: "Error-Free Automation",
      gradient: "white"
    },
    {
      icon: <ScrollText className="w-6 h-6" />,
      title: "Postprocessing",
      description: "Refine extracted text using contextual analysis, validation, and reformatting for high-quality data.",
      metric: "22+",
    ...
    },
    {
      ...
      description: "Effortlessly decodes Captchas and extracts details with precision using AI-powered models.",
      metric: "0.1s",
    ...
    },
    {
      ...
      description: "Generates unique identifiers to track documents securely and handles high volumes effortlessly.",
      metric: "1:1M",
    ...
    },
    {
      ...
      description: "Supports processing multiple documents at once with immediate feedback and manual correction options.",
      metric: "97%",
      metricLabel: "Real-Time Feedback",
      gradient: "white"
    },
    {
      icon: <LineChart className="w-6 h-6" />,
      title: "Interactive Dashboard",
      description: "Provides an intuitive interface with dynamic visualizations to track progress and manage workflows efficiently.",
      metric: "97%",
    ...
    },
    {
      ...
      title: "Interactive Dashboard",
      description: "Provides an intuitive interface with dynamic visualizations to track progress and manage documents",
      metric: "97%",
      metricLabel: "Intent Accuracy",
      gradient: "white"
    }
  ...
  const stats = [
    { value: "500K+", label: "Captchas Processed", icon: <Activity className="w-5 h-5" /> },
    { value: "99.8%", label: "Recognition Accuracy", icon: <Target className="w-5 h-5" /> },
    { value: "50+", label: "System Integrations", icon: <Building2 className="w-5 h-5" /> },
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center mb-12 group cursor-pointer">
            <div className="flex items-center px-6 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full border border-blue-100/50 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-blue-700 tracking-wide">
                Next-Generation AI Solution for Captcha Solving
              </span>
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-gray-700 tracking-wide">
               Automated Image Processing
                {/* <span className="text-blue-600 font-medium">Deed Documents</span> */}
              </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-16 max-w-3xl mx-auto font-light opacity-0 animate-fade-in-delayed">
            AI-powered solution turning complex visual data into actionable insights for finance,
engineering, and public sectors.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
            ...
            >
              <div className="relative z-10 flex items-center px-8 py-4 bg-black text-white rounded-full transition-all duration-500 group-hover:bg-blue-600">
                ...
                <span className="font-medium tracking-wide">Request a Demo</span>
            ...
            <div>
              ...
              <div className="space-y-8">
                {[
                  {
                    number: "01",
                    title: "Advanced OCR &amp; Image Processing",
                    desc: "Extracts text and details from Captchas and documents with high accuracy.",
                    icon: <FileSearch className="w-5 h-5" />
                  },
                  {
                    number: "02",
                    title: "NLP Analysis", 
                    desc: "Intelligently interprets and categorizes extracted text.",
                    icon: <Brain className="w-5 h-5" />
                  },
                  {
                    number: "03",
                    title: "Real-Time Processing",
                    desc: "Delivers immediate, precise results for high-volume tasks.",
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-3xl p-4 shadow-lg overflow-hidden">
                ...
                <div className="text-center mb-12">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">
                    <span className="text-blue-600">AI-Powered</span> Captcha Automation
                  </h3>
                ...
                <div className="space-y-6">
                  {[
                    { 
                      name: "Captcha Transcriber",
                      description: "Converts Captchas into machine-readable text.",
                    ...
                    { 
                      name: "Data Extractor",
                      description: "Identifies key fields from scanned documents.",
                    ...
                    { 
                      ...
                      description: "Organizes extracted data for structured workflows.",
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Real-time Processing",
                features: ["Instant Captcha decoding", "Fast document data extraction", "Immediate actionable outputs"],
                icon: <Zap className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              },
              {
                title: "Advanced Security",
                features: ["End-to-end encryption", "Secure cloud storage", "Access control for sensitive data"],
                icon: <Lock className="w-6 h-6" />,
                gradient: "white"
              },
              {
                title: "AI Analytics",
                features: ["Pattern recognition", "Automated classification", "Predictive insights from extracted data"],
                icon: <Brain className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              }
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-16 max-w-2xl mx-auto font-light">
            Measurable results demonstrating the power of AI-driven Captcha and document
processing
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { value: "500K+", label: "Captchas Processed", desc: "Fast, large-scale automation", icon: <TrendingUp className="w-5 h-5" /> },
              { value: "22+", label: "Languages Supported", desc: "Multilingual text extraction and processing", icon: <Zap className="w-5 h-5" /> },
              { value: "97%", label: "Accuracy", desc: "Reliable data extraction and classification", icon: <Award className="w-5 h-5" /> }
            ].map((impact, index) => (
              <div
                key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed font-light max-w-2xl mx-auto">
              Experience AI-powered Captcha and document automation.
            </p>
          </div>
