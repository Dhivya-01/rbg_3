...
import {
  ...
  ArrowDown, Sparkles, LineChart, Activity
} from "lucide-react";
...
const DhvaniPage = () => {
  ...
  const features = [
    {
      ...
      description: "Secure storage and integration with law enforcement systems for comprehensive analysis.",
      metric: "99.9%",
    ...
    },
    {
      ...
      title: "Noise Reduction -  Audio Clarity",
      description: "Advanced filtering and speaker separation for crystal-clear audio analysis",
      metric: "95%",
    ...
    },
    {
      ...
      description: "Near real-time audio-to-text conversion across Indic languages.",
      metric: "22+",
    ...
    },
    {
      ...
      description: "Fast and precise speaker identification using unique vocal traits.",
      metric: "0.1s",
    ...
    },
    {
      ...
      description: "Generates unique voice identifiers to track individuals across cases.",
      metric: "1:1M",
    ...
    },
    {
      ...
      title: "NLP Analysis",
      description: "Advanced semantic analysis for intent detection and conversation categorization.",
      metric: "97%",
  ...
  const stats = [
    { value: "500K+", label: "Voice Samples Analyzed", icon: <Activity className="w-5 h-5" /> },
    { value: "99.8%", label: "Identification Accuracy", icon: <Target className="w-5 h-5" /> },
    { value: "50+", label: "Law Enforcement Agencies Supported", icon: <Building2 className="w-5 h-5" /> },
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center mb-12 group cursor-pointer">
            <div className="flex items-center px-6 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full border border-blue-100/50 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-blue-700 tracking-wide">
                Developed for advanced multilingual AI applications
              </span>
          ...
          <div className="mb-16 relative">
            ...
            <h1 className="relative text-[6rem] md:text-[8rem] lg:text-[12rem] font-extralight leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-blue-600 to-gray-900 mb-8">
              {typedText}
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-gray-700 tracking-wide">
                Voice Recognition{" "}
                <span className="text-blue-600 font-medium">Reimagined</span>
              </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-16 max-w-3xl mx-auto font-light opacity-0 animate-fade-in-delayed">
            A next-generation AI platform for real-time multilingual speech and text processing, enabling translation, transcription, and classification.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light">
              Discover the cutting-edge capabilities that make Dhvani Core a leading AI-powered voice analysis platform:
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    desc: "Transformer-based AI models for high-accuracy speech and text processing.",
                    icon: <Brain className="w-5 h-5" />
                  },
                  {
                    number: "02",
                    title: "Edge Computing", 
                    desc: "Real-time distributed processing for instant results.",
                    icon: <Zap className="w-5 h-5" />
                  },
                  {
                    number: "03",
                    title: "Signal Processing",
                    desc: "Advanced algorithms for noise reduction and audio enhancement.",
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-3xl p-4 shadow-lg overflow-hidden">
                ...
                <div className="text-center mb-12">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">
                    <span className="text-blue-600">Dhvani Core</span>
                  </h3>
                ...
                <div className="space-y-6">
                  {[
                    { 
                      name: "Transcriber",
                      description: "Converts speech to text with high accuracy across 22+ languages.",
                    ...
                    { 
                      name: "Enhance",
                      description: "Real-time noise reduction and audio optimization for clear analysis.",
                    ...
                    { 
                      name: "Separate",
                      description: " Advanced speaker diarization for accurate identification.",
                    ...
                    { 
                      name: "Classify",
                      description: "Deep neural networks for voice pattern recognition",
                      icon: <Brain className="w-5 h-5" />,
                      status: "Optimized",
                      color: "indigo",
                       gradient: "from-blue-300 to-blue-500",
                    ...
                    { 
                      name: "Cluster",
                      description: "Groups similar voice characteristics for pattern analysis and insights.",
            ...
            {[
              {
                ...
                features: ["Live audio streaming", "Instant transcription", "Real-time identification"],
                icon: <Zap className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              },
              {
                title: "Advanced Security",
                features: ["End-to-end encryption", "Secure cloud storage", "Access control"],
                icon: <Lock className="w-6 h-6" />,
                gradient: "white"
              },
              {
                title: "AI Analytics",
                features: ["Voice pattern recognition", "Behavioral analysis", "Predictive insights"],
                icon: <Brain className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              }
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-16 max-w-2xl mx-auto font-light">
            Measurable results demonstrating the power of AI-driven voice and text analysis
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { value: ">500K", label: "Voice Samples Processed", desc: "Near real-time transcription, translation, and text analysis", icon: <TrendingUp className="w-5 h-5" /> },
              { value: "22+", label: "Languages Supported", desc: "Accurate multilingual voice and text understanding across diverse languages.", icon: <Zap className="w-5 h-5" /> },
              { value: ">95% ", label: "Accuracy", desc: "Precise speaker identification, classification, and intent detection for actionable intelligence.", icon: <Award className="w-5 h-5" /> }
            ].map((impact, index) => (
              <div
                key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            <h2 className="text-4xl md:text-6xl font-light text-gray-900 mb-8 leading-tight">
              ...
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
                Smarter Voice & Text Analysis?
              </span>
            </h2>
            
            <p className="text-lg text-gray-600 leading-relaxed font-light max-w-2xl mx-auto">
              Transform investigations with Dhvani Core in real-time multilingual processing.
            </p>
          </div>
