...
const DhvaniPage = () => {
  ...
  const features = [
    {
      ...
      description: "Extracts text from scanned or image files.",
      metric: "99.9%",
    ...
    },
    {
      ...
      title: "Automation",
      description: "Minimizes manual errors in data.",
      metric: "95%",
      metricLabel: "Error-Free",
      gradient: "white"
    },
    {
      icon: <ScrollText className="w-6 h-6" />,
      title: "Multilingual Support",
      description: "Processes documents across regions.",
      metric: "22+",
    ...
    },
    {
      ...
      title: "Rapid Parsing",
      description: "Extracts data in real time.",
      metric: "0.1s",
    ...
    },
    {
      ...
      description: "Ensures secure record management.",
      metric: "1:1M",
    ...
    },
    {
      ...
      description: "Handles high-volume documents.",
      metric: "97%",
    ...
    },
    {
      ...
      description: "Instant validation with manual corrections.",
      metric: "97%",
      metricLabel: "Accuracy",
      gradient: "white"
    },
    {
      ...
      description: "Track progress with intuitive visuals.",
      metric: "97%",
      metricLabel: " Accuracy",
      gradient: "white"
    }
  ...
  const stats = [
    { value: "500K+", label: "Deeds Processed", icon: <Activity className="w-5 h-5" /> },
    { value: "99.8%", label: "Extraction Accuracy", icon: <Target className="w-5 h-5" /> },
    { value: "50+", label: "System Integrations", icon: <Building2 className="w-5 h-5" /> },
    { value: "24/7", label: "Continuous Availability", icon: <Clock className="w-5 h-5" /> }
  ];
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="inline-flex items-center mb-12 group cursor-pointer">
            <div className="flex items-center px-6 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-full border border-blue-100/50 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-blue-700 tracking-wide">
                AI Solution for Automated Deed Processing
              </span>
          ...
          <div className="mb-16 relative">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl font-light text-gray-700 tracking-wide">
               Automated Property
                <span className="text-blue-600 font-medium">Document Processing</span>
              </h2>
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-16 max-w-3xl mx-auto font-light opacity-0 animate-fade-in-delayed">
            AI solution that converts property deeds into structured, searchable, and actionable
data.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light">
              AI-powered features for fast, accurate property document processing.
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    desc: "Extracts key fields and metadata from deeds.",
                    icon: <FileSearch className="w-5 h-5" />
                  },
                  {
                    number: "02",
                    title: "NLP Analysis", 
                    desc: "Categorizes text into structured data.",
                    icon: <Brain className="w-5 h-5" />
                  },
                  {
                    number: "03",
                    title: "Real-Time Processing",
                    desc: "Fast, actionable results for high-volume documents.",
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-3xl p-4 shadow-lg overflow-hidden">
                ...
                <div className="text-center mb-12">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">
                    <span className="text-blue-600">AI-Powered</span>Document Processing
                  </h3>
                ...
                <div className="space-y-6">
                  {[
                    { 
                      name: "Transcriber",
                      description: "Extracts text from property deeds.",
                    ...
                    { 
                      name: "Data Extractor",
                      description: "Pulls key fields like owner and plot details",
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Real-time Processing",
                features: ["Instant document parsing", "Fast data extraction", "Immediate actionable outputs"],
                icon: <Zap className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              },
              {
                title: "Advanced Security",
                features: ["End-to-end encryption", "Secure cloud storage", "Access control for sensitive records"],
                icon: <Lock className="w-6 h-6" />,
                gradient: "white"
              },
              {
                title: "AI Analytics",
                features: ["Pattern recognition in deeds", "Automated classification", "Predictive insights  for compliance"],
                icon: <Brain className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              }
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { value: "500K", label: "Deeds Processed", desc: "High-volume automation", icon: <TrendingUp className="w-5 h-5" /> },
              { value: "10x", label: "Processing Speed", desc: "Accelerated document parsing and extraction", icon: <Zap className="w-5 h-5" /> },
              { value: "97%", label: "Accuracy", desc: "Reliable extraction of key fields and metadata", icon: <Award className="w-5 h-5" /> }
            ].map((impact, index) => (
              <div
                key={index}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed font-light max-w-2xl mx-auto">
              Experience the future of AI-powered property deed processing.
            </p>
          </div>
