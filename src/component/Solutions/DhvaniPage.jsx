  ...
  const features = [
    {
      ...
      description: "Secure storage with LEA system integration",
      metric: "99.9%",
    ...
    },
    {
      ...
      description: "Filtering and speaker separation for clear audio  ",
      metric: "95%",
    ...
    },
    {
      ...
      description: "Audio-to-text in Indic languages",
      metric: "22+",
    ...
    },
    {
      ...
      description: "Precise speaker identification via vocal traits",
      metric: "0.1s",
    ...
    },
    {
      ...
      description: "Unique voice IDs to track individuals",
      metric: "1:1M",
    ...
    },
    {
      ...
      title: "NLP Analysis",
      description: "Semantic analysis for intent detection and conversation categorization",
      metric: "97%",
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-16 max-w-3xl mx-auto font-light opacity-0 animate-fade-in-delayed">
            AI-powered voice analysis platform for advanced cybercrime investigations.
          </p>
                ...
                {[
                  {
                    ...
                    desc: "Transformer-based deep learning for high accuracy",
                    icon: <Brain className="w-5 h-5" />
                  },
                  {
                    number: "02",
                    title: "Edge Computing", 
                    desc: "Real-time distributed processing",
                    icon: <Zap className="w-5 h-5" />
                  },
                  {
                    number: "03",
                    title: "Signal Processing",
                    desc: "Advanced audio enhancement and noise reduction",
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-3xl p-4 shadow-lg overflow-hidden">
                ...
                <div className="text-center mb-12">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">
                    <span className="text-blue-600">RBG.AI</span> MLStack
                  </h3>
                ...
                <div className="space-y-6">
                  {[
                    { 
                      ...
                      description: "Speech-to-text, 22+ languages (95% accuracy)",
                    ...
                    { 
                      name: "Voice Enhancer",
                      description: "Real-time noise reduction",
                    ...
                    { 
                      name: "Voice Diarizer",
                      description: "Speaker separation",
                    ...
                    { 
                      ...
                      description: "Voice pattern classification",
                      icon: <Brain className="w-5 h-5" />,
                      status: "Optimized",
                      color: "indigo",
                       gradient: "from-blue-300 to-blue-500",
                    ...
                    { 
                      ...
                      description: "Groups similar voices",
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                title: "AI Analytics",
                features: ["Pattern recognition", "Behavioral analysis", "Predictive insights"],
                icon: <Brain className="w-6 h-6" />,
                gradient: "from-blue-50 to-indigo-50"
              }
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-16 max-w-2xl mx-auto font-light">
            Proven results showcasing AI-driven voice analysis.
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed font-light max-w-2xl mx-auto">
              Discover next-gen AI for voice-based cybercrime investigation.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
            ...
            >
              <button className="relative z-10 flex items-center px-8 py-4 bg-black text-white rounded-full transition-all duration-500 group-hover:bg-blue-600">
